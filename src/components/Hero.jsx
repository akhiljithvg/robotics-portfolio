...
const Hero = () => {
    ...
    return (
        <section id="about" className="pt-32 pb-16 md:pt-48 md:pb-32 flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-1 w-full max-w-lg relative">
                ...
                <div className="absolute -z-10 -top-10 -right-10 w-full h-full bg-[radial-gradient(#3b82f6_1px,transparent_1px)] [background-size:16px_16px] opacity-20"></div>
            </div>
        </section>
    );
};
